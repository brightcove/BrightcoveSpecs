Pod::Spec.new do |s|
  ...
  s.subspec "XCFramework" do |ss|
    ss.ios.resource_bundle     = { 'BCOVPUIResources' => 'ios/dynamic/BrightcovePlayerSDK.xcframework/ios-arm64/BrightcovePlayerSDK.framework/bcovpuiiconfont.ttf' }

    ss.ios.vendored_framework  = "ios/dynamic/BrightcovePlayerSDK.xcframework"
    ss.tvos.vendored_framework = "tvos/BrightcovePlayerSDK.xcframework"
  end
