Pod::Spec.new do |s|
  ...
  s.subspec "default" do |ss|
    ...
    ss.ios.frameworks  = 'AdSupport', 'AVFoundation', 'AVKit', 'CoreMedia', 'CoreMotion', 'GLKit', 'MediaAccessibility', 'MediaPlayer', 'SafariServices', 'SystemConfiguration', 'WebKit'
    ...
    ss.tvos.frameworks  = 'AdSupport', 'AVFoundation', 'CoreMedia', 'GLKit', 'MediaPlayer'
