Pod::Spec.new do |s|
  ...
  s.vendored_framework = "xcframework/BrightcovePlayerSDK.xcframework"

  s.source_files       = "DeprecationNotice/Notice.m"

  s.resource           = "xcframework/BrightcovePlayerSDK.xcframework/ios-arm64/BrightcovePlayerSDK.framework/BCOVPUIResources.bundle"
