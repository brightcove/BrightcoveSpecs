Pod::Spec.new do |s|
  ...
  s.subspec "Framework" do |ss|
    ss.dependency 'Brightcove-Player-Core', '6.12.0'
  ...
  s.subspec "XCFramework" do |ss|
    ss.dependency 'Brightcove-Player-Core/XCFramework', '6.12.0'

    ss.ios.vendored_framework  = "xcframework/BrightcoveIMA.xcframework"
    ss.tvos.vendored_framework = "tvos/BrightcoveIMA.framework"
