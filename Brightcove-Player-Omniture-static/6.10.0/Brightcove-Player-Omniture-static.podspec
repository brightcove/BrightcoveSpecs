Pod::Spec.new do |s|
  ...
  s.subspec "Framework" do |ss|
    ss.dependency 'Brightcove-Player-Core-static', '6.10.0'
  ...
  s.subspec "XCFramework" do |ss|
    ss.dependency 'Brightcove-Player-Core-static/XCFramework', '6.10.0'

    ss.ios.vendored_framework = "ios/BrightcoveAMC.xcframework"
  end
