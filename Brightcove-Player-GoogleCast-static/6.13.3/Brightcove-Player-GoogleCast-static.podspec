Pod::Spec.new do |s|
  ...
  s.subspec "Bluetooth" do |ss|
    ...
    ss.dependency "google-cast-sdk", "4.8.1"

    ss.subspec "Framework" do |f|
      f.dependency "Brightcove-Player-Core", "6.13.3"
    ...
    ss.subspec "XCFramework" do |xc|
      xc.dependency "Brightcove-Player-Core/XCFramework", "6.13.3"
  ...
  s.subspec "No-Bluetooth" do |ss|
    ...
    ss.dependency "google-cast-sdk-no-bluetooth", "4.8.1"
