Pod::Spec.new do |s|
  ...
  s.subspec "Framework" do |ss|
    ss.ios.dependency 'Brightcove-Player-Core-static', '6.10.5'
    # Brightcove SDK for tvOS is dynamic-only
    ss.tvos.dependency 'Brightcove-Player-Core', '6.10.5'
  ...
  s.subspec "XCFramework" do |ss|
    ss.ios.dependency 'Brightcove-Player-Core-static/XCFramework', '6.10.5'
    # Brightcove SDK for tvOS is dynamic-only
    ss.tvos.dependency 'Brightcove-Player-Core/XCFramework', '6.10.5'
