Pod::Spec.new do |s|
  ...
  s.subspec "Framework" do |ss|
    ss.ios.dependency 'Brightcove-Player-Core-static', '6.11.1'
    # Brightcove SDK for tvOS is dynamic-only
    ss.tvos.dependency 'Brightcove-Player-Core', '6.11.1'
  ...
  s.subspec "XCFramework" do |ss|
    ss.ios.dependency 'Brightcove-Player-Core-static/XCFramework', '6.11.1'
    # Brightcove SDK for tvOS is dynamic-only
    ss.tvos.dependency 'Brightcove-Player-Core/XCFramework', '6.11.1'
