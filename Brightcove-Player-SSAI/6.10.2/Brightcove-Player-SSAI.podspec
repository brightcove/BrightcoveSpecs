Pod::Spec.new do |s|
  ...
  s.subspec "Framework" do |ss|
    ss.dependency 'Brightcove-Player-Core', '6.10.2'
    ss.ios.dependency 'Brightcove-Player-OpenMeasurement', '6.10.2'
  ...
  s.subspec "XCFramework" do |ss|
    ss.dependency 'Brightcove-Player-Core/XCFramework', '6.10.2'
    ss.ios.dependency 'Brightcove-Player-OpenMeasurement', '6.10.2'
