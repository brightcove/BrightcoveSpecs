Pod::Spec.new do |s|
  ...
  s.subspec "Framework" do |ss|
    ss.dependency 'Brightcove-Player-Core', '6.10.1'
    ss.ios.dependency 'Brightcove-Player-OpenMeasurement', '6.10.1'
  ...
  s.subspec "XCFramework" do |ss|
    ss.dependency 'Brightcove-Player-Core/XCFramework', '6.10.1'
    ss.ios.dependency 'Brightcove-Player-OpenMeasurement', '6.10.1'
    ...
    ss.tvos.vendored_framework = "tvos/BrightcoveSSAI.xcframework"
  end
